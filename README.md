...
microcontroller receives messages from Node-Red website to control Red, Yellow and Green LEDs and display status of each LED
...
-ESP32 (where we put our code to do specific functions)

-LEDs (as a Traffic Light)

<h2 align="left">
Tools used:
</h2>

-Visual Studio using ESP IDF
